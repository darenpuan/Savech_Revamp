    ...
    <section id="contact" style="background-image:url('assets/img/fingerTablet.jpg');">
        <div class="container" style="text-align: left;">
            ...
            <div style="padding-left: 5%; padding-right: 10%">
                <form name="contactForm" onsubmit="return validateForm()" action="mail.php" method="POST">
                    <div class="form-group">
                        <label class="sr-only" for="name-id">Name</label>
                        <input name="name" class="form-control" id="name-id" type="text" placeholder="Name">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="email-id">Email</label>
                        <input name="email" class="form-control" id="email-id" type="email" placeholder="Email" autocomplete="on">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="subject-id">Subject</label>
                        <input name="subject" class="form-control" id="subject-id" type="text" placeholder="Subject">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="message-id">Message</label>
                        <textarea name="message" class="form-control" id="message-id" placeholder="Message"></textarea>
                    </div>
                    <button name="submit" class="btn btn-submit pull-right" type="submit" value="Submit"><span>Submit</span></button>
                </form>
                <!--
                <form name="contactForm" method="POST" action="http://formspree.io/enquiries@Savech.com.sg" onsubmit="return validateForm()">
                    <div class="form-group">
                        <label for="name-id" class="sr-only">Name</label>
                        <input type="text" class="form-control" name="name" id="name-id" placeholder="Name">
                    </div>
                    <div class="form-group">
                        <label for="email-id" class="sr-only">Email</label>
                        <input type="email" class="form-control" name="email" id="email-id" placeholder="Email" autocomplete="on">
                    </div>
                    <div class="form-group">
                        <label for="subject-id" class="sr-only">Subject</label>
                        <input type="text" class="form-control" name="subject" id="subject-id" placeholder="Subject">
                    </div>
                    <div class="form-group">
                        <label for="message-id" class="sr-only">Message</label>
                        <textarea class="form-control" name="message" id="message-id" placeholder="Message"></textarea>
                    </div>
                    <button type="submit" class="btn btn-submit pull-right"><span>Submit</span></button>
                </form>
-->
            </div>
        </div>
